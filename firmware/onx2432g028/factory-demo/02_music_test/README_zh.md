...
本示例演示在 ONX2432G028 开发板（ESP32-S3）上使用 SD 卡播放音频文件，并通过 LCD 触摸屏进行简单交互。界面基于 LVGL，音频输出使用板载喇叭。
...
### 源码
- [ESP-IDF 版本 - 02_music_test](https://github.com/OpenNextion/OpenNextion-SKU-ONX2432G028/tree/main/Example%20Programs/ESP-IDF/02_music_test)
- [ESP-Arduino 版本 - 02_music_test](https://github.com/OpenNextion/OpenNextion-SKU-ONX2432G028/tree/main/Example%20Programs/ESP-Arduino/02_music_test)
