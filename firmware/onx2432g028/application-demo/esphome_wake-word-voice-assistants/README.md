...
This firmware is the wake word voice assistant build for `ONX2432G028`. It turns the OpenNextion board into a Home Assistant voice assistant endpoint with on-device wake word detection, Wi-Fi provisioning, microphone capture, speaker playback, and interactive voice sessions.

## Firmware Information

| Item | Value |
| :--- | :--- |
| Supported Board | ONX2432G028 |
...
- [ONX2432G028 product information](https://github.com/OpenNextion/OpenNextion-SKU-ONX2432G028)
