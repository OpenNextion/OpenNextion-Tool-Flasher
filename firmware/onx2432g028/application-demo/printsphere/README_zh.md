# OpenNextion PrintSphere - 拓竹打印机桌面状态屏 (ONX2432G028)

将开源项目 [PrintSphere](https://github.com/cptkirki/PrintSphere) 移植到 OpenNextion ONX2432G028（2.8 寸）矩形 ESP32-S3 显示屏，在桌面上实时显示拓竹（Bambu Lab）3D 打印机的状态。
...
- **LCD**：2.8 寸 SPI TFT（320×240，横屏）
- **触摸**：CST826 I2C 电容触摸控制器
- **IO 扩展**：PCF8574 I2C IO 扩展芯片
- **Flash**：16 MB
- **开发板**：[ONX2432G028](https://nextion.tech/wiki/onx2432g028/)
...
[ONX2432G028 桌面支架（MakerWorld）](https://makerworld.com/models/2950328-printsphere-ported-to-opennextion-for-2-8-inch-bam#profileId-3305542)

### 产品购买链接

[ONX2432G028（2.8 寸 ESP32-S3 LCD）](https://itead.cc/product/open-nextion-2-8-genius-series-esp32-s3-lcd-touchscreen-development-board/)

### 产品资料

[ONX2432G028 Wiki 与原理图](https://nextion.tech/wiki/onx2432g028/)  
[ONX2432G028 GitHub SKU 仓库](https://github.com/OpenNextion/OpenNextion-SKU-ONX2432G028)
