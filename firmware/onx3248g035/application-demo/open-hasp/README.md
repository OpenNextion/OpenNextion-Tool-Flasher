...
This firmware is the openHASP build for `ONX3248G035`. It turns the OpenNextion 3.5-inch ESP32-S3 touch display into a Home Assistant / MQTT smart home control panel.
...
- This firmware comes from the `onx3248g035` build output of `OpenNextion-Example-openHASP`.
...
- [ONX3248G035 Product Resources](https://github.com/OpenNextion/OpenNextion-SKU-ONX3248G035)
