...
本固件为 `ONX3248G035` 适配的 openHASP 固件，可将 OpenNextion 3.5 英寸 ESP32-S3 触控屏作为 Home Assistant / MQTT 智能家居控制面板使用。
...
- 本固件来自 `OpenNextion-Example-openHASP` 项目的 `onx3248g035` 构建产物。
