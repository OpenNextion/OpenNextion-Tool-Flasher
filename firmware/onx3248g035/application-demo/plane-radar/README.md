...
This firmware is the Plane Radar build for `ONX3248G035`. It shows a live aircraft radar view based on ADS-B data and provides first-boot Wi-Fi setup and location configuration for desktop flight-tracking and information display use cases.
...
| Flash | 16MB |
| Flash address | 0x0 |
| Display orientation | Landscape (480×320) |
| Source branch | main |
